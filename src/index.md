...
[ワークショップスポンサーの募集](#ワークショップスポンサーの募集)を開始しました。
...
※ ワークショップスポンサーは言語処理学会第28回年次大会のスポンサーとは異なるJED2022独自のものです  

### ワークショップスポンサー募集要項

- お申し込み期限：2022年2月18日(金)まで
- スポンサー料金：税込55,000円を言語処理学会を通じてお支払いいただきます
  - ワークショップスポンサーにランクはありません
...
1. JED2022サイトトップページおよびプログラムページにロゴの掲載が可能（画面幅の約20%の正方形領域・URLリンクの設定が可能）
1. 午前の部・午後の部の開始前にZoom画面で共有するタイトルスライドにロゴの掲載が可能（画面幅の約15%の正方形領域）
1. 昼休憩中にZoom画面で共有するスライドショーに静止画広告（音声なし）を1枚差し込み可能

※ ロゴの掲載はロゴデータ受取後2営業日以内に開始〜2022年3月末までとなります  
※ ロゴや静止画広告の表示順序は全てお申し込み順となります  
※ ワークショップスポンサー特典に無料参加枠はございません（ワークショップに参加される方はNLP2022への参加登録が必要です）
